...
function generateRandomCoefficients() {
    ...
    do {
        coefficient1 = (Math.random() * 0.7 + 2.3).toFixed(2); // Generate random number between 2.3 and 3.0
        coefficient2 = (Math.random() * 2 + parseFloat(coefficient1) * 2).toFixed(2); // Generate random number between 2*coefficient1 and 3*coefficient1
